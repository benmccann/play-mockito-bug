...
public class IntegrationTest84 {
  ...
  private void readFileIntoSet(Set<String> set, String resource) {
    BufferedReader reader = new BufferedReader(new InputStreamReader(IntegrationTest84.class.getClassLoader().getResourceAsStream(resource)));
    String line;
    try {
