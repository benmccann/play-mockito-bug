...
public class IntegrationTest71 {
  ...
  private void readFileIntoSet(Set<String> set, String resource) {
    BufferedReader reader = new BufferedReader(new InputStreamReader(IntegrationTest71.class.getClassLoader().getResourceAsStream(resource)));
    String line;
    try {
