...
public class IntegrationTest59 {
  ...
  private void readFileIntoSet(Set<String> set, String resource) {
    BufferedReader reader = new BufferedReader(new InputStreamReader(IntegrationTest59.class.getClassLoader().getResourceAsStream(resource)));
    String line;
    try {
