...
public class IntegrationTest97 {
  ...
  private void readFileIntoSet(Set<String> set, String resource) {
    BufferedReader reader = new BufferedReader(new InputStreamReader(IntegrationTest97.class.getClassLoader().getResourceAsStream(resource)));
    String line;
    try {
