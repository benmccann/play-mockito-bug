...
public class IntegrationTest82 {
  ...
  private void readFileIntoSet(Set<String> set, String resource) {
    BufferedReader reader = new BufferedReader(new InputStreamReader(IntegrationTest82.class.getClassLoader().getResourceAsStream(resource)));
    String line;
    try {
