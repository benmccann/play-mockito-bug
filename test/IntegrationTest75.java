...
public class IntegrationTest75 {
  ...
  private void readFileIntoSet(Set<String> set, String resource) {
    BufferedReader reader = new BufferedReader(new InputStreamReader(IntegrationTest75.class.getClassLoader().getResourceAsStream(resource)));
    String line;
    try {
