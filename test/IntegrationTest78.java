...
public class IntegrationTest78 {
  ...
  private void readFileIntoSet(Set<String> set, String resource) {
    BufferedReader reader = new BufferedReader(new InputStreamReader(IntegrationTest78.class.getClassLoader().getResourceAsStream(resource)));
    String line;
    try {
