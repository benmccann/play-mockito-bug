...
public class IntegrationTest63 {
  ...
  private void readFileIntoSet(Set<String> set, String resource) {
    BufferedReader reader = new BufferedReader(new InputStreamReader(IntegrationTest63.class.getClassLoader().getResourceAsStream(resource)));
    String line;
    try {
