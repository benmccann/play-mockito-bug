...
public class IntegrationTest52 {
  ...
  private void readFileIntoSet(Set<String> set, String resource) {
    BufferedReader reader = new BufferedReader(new InputStreamReader(IntegrationTest52.class.getClassLoader().getResourceAsStream(resource)));
    String line;
    try {
