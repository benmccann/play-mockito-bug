...
public class IntegrationTest94 {
  ...
  private void readFileIntoSet(Set<String> set, String resource) {
    BufferedReader reader = new BufferedReader(new InputStreamReader(IntegrationTest94.class.getClassLoader().getResourceAsStream(resource)));
    String line;
    try {
