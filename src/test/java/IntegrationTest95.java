...
public class IntegrationTest95 {
  ...
  private void readFileIntoSet(Set<String> set, String resource) {
    BufferedReader reader = new BufferedReader(new InputStreamReader(IntegrationTest95.class.getClassLoader().getResourceAsStream(resource)));
    String line;
    try {
