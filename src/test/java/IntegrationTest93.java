...
public class IntegrationTest93 {
  ...
  private void readFileIntoSet(Set<String> set, String resource) {
    BufferedReader reader = new BufferedReader(new InputStreamReader(IntegrationTest93.class.getClassLoader().getResourceAsStream(resource)));
    String line;
    try {
