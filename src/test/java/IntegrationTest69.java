...
public class IntegrationTest69 {
  ...
  private void readFileIntoSet(Set<String> set, String resource) {
    BufferedReader reader = new BufferedReader(new InputStreamReader(IntegrationTest69.class.getClassLoader().getResourceAsStream(resource)));
    String line;
    try {
