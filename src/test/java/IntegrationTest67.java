...
public class IntegrationTest67 {
  ...
  private void readFileIntoSet(Set<String> set, String resource) {
    BufferedReader reader = new BufferedReader(new InputStreamReader(IntegrationTest67.class.getClassLoader().getResourceAsStream(resource)));
    String line;
    try {
