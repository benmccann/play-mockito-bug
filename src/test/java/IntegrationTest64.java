...
public class IntegrationTest64 {
  ...
  private void readFileIntoSet(Set<String> set, String resource) {
    BufferedReader reader = new BufferedReader(new InputStreamReader(IntegrationTest64.class.getClassLoader().getResourceAsStream(resource)));
    String line;
    try {
