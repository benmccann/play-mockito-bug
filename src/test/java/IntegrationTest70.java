...
public class IntegrationTest70 {
  ...
  private void readFileIntoSet(Set<String> set, String resource) {
    BufferedReader reader = new BufferedReader(new InputStreamReader(IntegrationTest70.class.getClassLoader().getResourceAsStream(resource)));
    String line;
    try {
