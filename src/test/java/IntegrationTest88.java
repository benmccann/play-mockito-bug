...
public class IntegrationTest88 {
  ...
  private void readFileIntoSet(Set<String> set, String resource) {
    BufferedReader reader = new BufferedReader(new InputStreamReader(IntegrationTest88.class.getClassLoader().getResourceAsStream(resource)));
    String line;
    try {
