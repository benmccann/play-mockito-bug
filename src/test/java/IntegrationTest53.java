...
public class IntegrationTest53 {
  ...
  private void readFileIntoSet(Set<String> set, String resource) {
    BufferedReader reader = new BufferedReader(new InputStreamReader(IntegrationTest53.class.getClassLoader().getResourceAsStream(resource)));
    String line;
    try {
