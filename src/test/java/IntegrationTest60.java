...
public class IntegrationTest60 {
  ...
  private void readFileIntoSet(Set<String> set, String resource) {
    BufferedReader reader = new BufferedReader(new InputStreamReader(IntegrationTest60.class.getClassLoader().getResourceAsStream(resource)));
    String line;
    try {
