...
public class IntegrationTest74 {
  ...
  private void readFileIntoSet(Set<String> set, String resource) {
    BufferedReader reader = new BufferedReader(new InputStreamReader(IntegrationTest74.class.getClassLoader().getResourceAsStream(resource)));
    String line;
    try {
