...
public class IntegrationTest98 {
  ...
  private void readFileIntoSet(Set<String> set, String resource) {
    BufferedReader reader = new BufferedReader(new InputStreamReader(IntegrationTest98.class.getClassLoader().getResourceAsStream(resource)));
    String line;
    try {
