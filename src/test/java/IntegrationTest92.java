...
public class IntegrationTest92 {
  ...
  private void readFileIntoSet(Set<String> set, String resource) {
    BufferedReader reader = new BufferedReader(new InputStreamReader(IntegrationTest92.class.getClassLoader().getResourceAsStream(resource)));
    String line;
    try {
