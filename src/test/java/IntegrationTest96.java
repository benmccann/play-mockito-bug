...
public class IntegrationTest96 {
  ...
  private void readFileIntoSet(Set<String> set, String resource) {
    BufferedReader reader = new BufferedReader(new InputStreamReader(IntegrationTest96.class.getClassLoader().getResourceAsStream(resource)));
    String line;
    try {
