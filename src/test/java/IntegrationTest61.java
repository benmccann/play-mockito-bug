...
public class IntegrationTest61 {
  ...
  private void readFileIntoSet(Set<String> set, String resource) {
    BufferedReader reader = new BufferedReader(new InputStreamReader(IntegrationTest61.class.getClassLoader().getResourceAsStream(resource)));
    String line;
    try {
